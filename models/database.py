...
class Messages(Base, UserMixin):
    ...
    def __repr__(self):
        return f"Messages('{self.username}', {self.email}, '{self.message}')"
...
class RobotProfile(Base, UserMixin):
    ...
    profile_description = Column(String(500), nullable=False)
    domicile = Column(String(80), nullable=False)
    processor_unit = Column(String(120), nullable=False)
    employment_status = Column(Enum("working robot", "disabled", "all"), nullable=False)
    ...
    def __repr__(self):
        return f"Profile('{self.user_robot}', '{self.type_of_robot}', '{self.name}', '{self.profile_description}', '{self.domicile}', '{self.processor_unit}', '{self.employment_status}')"
