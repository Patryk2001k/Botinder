...
class BotinderApiClient:
    ...
    def _fetch_new_token(self) -> str:
        ...
        try:
            ...
            logger.error(
                f"Network error during authorization with Botinder-API: {e}"
            )  # POPRAWKA
            return ""
    ...
    def get_coordinates(self, city_name: str) -> dict:
        ...
        try:
            ...
            logger.error(
                f"Network connection failed in API get_coordinates: {e}"
            )  # POPRAWKA
        return {}
    ...
    def get_distance(
        ...
        try:
            ...
            logger.error(
                f"Network connection failed in API get_distance: {e}"
            )  # POPRAWKA
        return {}
