...
app.config["UPLOADED_PHOTOS_DEST"] = f"app/static/images/current_user"
app.config["ALLOWED_IMAGE_EXTENSIONS"] = [".jpg", ".jpeg", ".png", ".gif"]
photos = UploadSet("photos", IMAGES)
configure_uploads(app, photos)

def get_image(photo):
    app.config["UPLOADED_PHOTOS_DEST"] = f"app/static/images/{current_user.name}"
    os.makedirs(f"app/static/images/{current_user.name}", exist_ok=True)
